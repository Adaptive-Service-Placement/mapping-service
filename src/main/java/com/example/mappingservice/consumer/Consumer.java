...
import com.example.mappingservice.servicemapping.Mapper;
...
public class Consumer {
    ...
    public void handleMappingRequest(ApplicationSystem applicationSystem) {
        ...
        // k = number of VM Instances or physical Servers available (still unknown on how to determine), big TODO
